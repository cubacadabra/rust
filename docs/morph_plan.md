...
- 2026-09-11: Replaced that visual-review blockout with a torso-skinned folded hood and curved white drawstrings. Bounded schema 3 packs now support up to eight contiguous material surfaces per LOD while schema 1/2 decoding stays compatible; surfaces can either inherit the live avatar tint or preserve an authored color without changing the normal character vertex path. The refined Person Top pack is 103,091 bytes with 2,000/864/336 Near/Mid/Far triangles, hash `47836b40be17a71735b390219d52bcbe61330cef9cfa17248c6edb5f662cdd43`, and migration `020_refine_person_hoodie_materials.sql` updates the catalog reference.
