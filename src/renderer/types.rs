...
pub struct Renderer {
    ...
    pub(super) world_mesh_shadow_pipeline: wgpu::RenderPipeline,
    pub(super) shadow_bind_group: wgpu::BindGroup,
    pub(super) shadow_globals_bind_group: wgpu::BindGroup,
    pub(super) shadow_globals_buffer: wgpu::Buffer,
    pub(super) shadow_depth_view: wgpu::TextureView,
    ...
    about_targets: targets::SceneTargets,
    ...
    pub(super) about_rendering: bool,
