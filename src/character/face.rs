...
impl FacePreset {
    ...
    pub(crate) const fn stable_id(self) -> &'static str {
        match self {
            ...
            Self::Sleepy => "sleepy",
            Self::Squinting => "squinting",
            Self::Wink => "wink",
            Self::Smirk => "smirk",
            Self::Confused => "confused",
            Self::Excited => "excited",
            Self::Unimpressed => "unimpressed",
        }
    }
}
...
pub(crate) struct FaceParameters {
    ...
    pub(crate) eye_asymmetry: f32,
    pub(crate) brow_asymmetry: f32,
    pub(crate) look: Vec2,
...
impl FaceParameters {
    pub(crate) fn preset(preset: FacePreset) -> Self {
        match preset {
            ...
            FacePreset::Sad => Self {
                ...
                brow_asymmetry: 0.0,
                eye_opening: 0.88,
                look: Vec2::new(0.0, -0.03),
                brow_tilt: 0.32,
                mouth_curve: -0.75,
                mouth_opening: 0.04,
            },
            FacePreset::Laughing => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 0.48,
                look: Vec2::ZERO,
            ...
            FacePreset::Curious => Self {
                eye_asymmetry: 0.03,
                brow_asymmetry: 0.025,
                eye_opening: 1.08,
                look: Vec2::new(0.08, 0.03),
                brow_tilt: 0.22,
                mouth_curve: 0.12,
                mouth_opening: 0.08,
            },
            FacePreset::Amazed => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 1.2,
                look: Vec2::new(0.0, 0.02),
            ...
            FacePreset::Crying => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 0.45,
                look: Vec2::new(0.0, -0.04),
                brow_tilt: 0.36,
                mouth_curve: -0.65,
                mouth_opening: 0.2,
            },
            FacePreset::Worried => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 0.92,
                look: Vec2::new(0.0, -0.02),
            ...
            FacePreset::Embarrassed => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 0.62,
                look: Vec2::new(0.1, -0.06),
                brow_tilt: 0.16,
                mouth_curve: 0.2,
                mouth_opening: 0.0,
            },
            FacePreset::Sleepy => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 0.4,
                look: Vec2::new(0.0, -0.08),
                brow_tilt: 0.0,
                mouth_curve: 0.0,
                mouth_opening: 0.0,
            },
            FacePreset::Squinting => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 0.38,
                look: Vec2::ZERO,
            ...
            FacePreset::Wink => Self {
                eye_asymmetry: 0.45,
                brow_asymmetry: 0.02,
                eye_opening: 0.58,
                look: Vec2::new(-0.04, 0.0),
                brow_tilt: 0.08,
                mouth_curve: 0.45,
                mouth_opening: 0.0,
            },
            FacePreset::Smirk => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 0.85,
                look: Vec2::new(0.05, 0.0),
                brow_tilt: -0.12,
                mouth_curve: 0.42,
                mouth_opening: 0.03,
            },
            FacePreset::Confused => Self {
                eye_asymmetry: 0.10,
                brow_asymmetry: 0.045,
                eye_opening: 1.0,
                look: Vec2::new(-0.07, 0.02),
                brow_tilt: 0.3,
                mouth_curve: -0.08,
                mouth_opening: 0.12,
            },
            FacePreset::Excited => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 1.18,
                look: Vec2::new(0.0, 0.04),
            ...
            FacePreset::Unimpressed => Self {
                eye_asymmetry: 0.0,
                brow_asymmetry: 0.0,
                eye_opening: 0.68,
                look: Vec2::new(0.0, -0.01),
                brow_tilt: -0.05,
                mouth_curve: -0.04,
                mouth_opening: 0.0,
            },
    ...
    pub(crate) fn clamped(self) -> Self {
        Self {
            eye_asymmetry: self.eye_asymmetry.clamp(-0.6, 0.6),
            brow_asymmetry: self.brow_asymmetry.clamp(-0.06, 0.06),
...
mod tests {
    ...
    fn face_parameters_are_bounded() {
        ...
        assert_eq!(face.eye_asymmetry, 0.6);
        assert_eq!(face.brow_asymmetry, 0.06);
